...
\renewcommand{\Ausgabedatum}{Mi. 15.11.20173}
...
\textbf{Raumtyp}(\underline{Bezeichnung},MinGrösse) \\
\textbf{Ausstattung}(\underline{\dashuline{Bezeichnung->Raumtyp.Bezeichnung},Raumausstattung}) \\
\textbf{Hotel}(Name,\underline{Adresse},\dashuline{Leiter->Manager.SVNr})\\
\textbf{Mitarbeiter}(\underline{SVNr},Name,Alter,\dashuline{Adresse->Hotel.Adresse}) \\
\textbf{Manager}(\underline{SVNr},TelNr) \\
\textbf{Hotelier}(\underline{SVNr},Befugnis) \\
\textbf{Dienstplan}(\underline{\dashuline{SVNr->Hotelier.SVNr},Jahr,Tag},von,bis)\\

\textbf{Besitzt}(\underline{\dashuline{Adresse->Hotel.Adresse}, \dashuline{Bezeichnung->Raumtyp.Bezeichnung}},Anzahl) \\
\textbf{Vertritt}(\underline{\dashuline{SVNr->Hotelier.SVNr} ,\dashuline{ VSVNr->Hotelier.SVNr}},Datum) \\
